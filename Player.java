...
public class Player extends Character{
	...
	private ArrayList<Double> healthFood = new ArrayList<Double>();
	...
	public Player(double h, double d, Point loc) throws IOException{
		...
		xLoc = (int) loc.getX();
		yLoc = (int) loc.getY();
		procrastionationBar = 5;
		food.add("Chocolate bar");
		food.add("Coffee");
		food.add("Apple");
		healthFood.add(getHealth()/4);
		healthFood.add(getHealth()/2);
		healthFood.add(getHealth()*3/4);
		dir = "DOWN"; // sprite is initially facing down
	}
